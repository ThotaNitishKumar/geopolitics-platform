            ...
            <div className="max-w-md w-full bg-geo-navy border border-gray-800 rounded-lg shadow-2xl p-8">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400 mt-2">
                        {otpSent ? "Verify your email address" : "Create an account to access intelligence"}
                    </p>
                </div>
                ...
                {message && !error && (
                    <div className="bg-green-900/50 border border-green-800 text-green-200 px-4 py-3 rounded mb-6 flex items-center gap-2">
                        <AlertCircle size={18} />
                        <span>{message}</span>
                    </div>
                )}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    maxLength="6"
                                    className="block w-full pl-10 pr-3 py-2 border border-gray-700 rounded-md leading-5 bg-gray-900 text-gray-300 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-geo-red focus:border-geo-red sm:text-sm text-center tracking-widest"
                                    placeholder="000000"
                                    value={otp}
