        ...
        <div className="min-h-screen bg-geo-dark flex items-center justify-center px-4">
            <div className="max-w-md w-full bg-geo-navy border border-gray-800 rounded-lg shadow-2xl p-8">
                <div className="text-center mb-8">
                    <h2 className="text-3xl font-bold text-gray-100">Access Intelligence</h2>
                    <p className="text-gray-400 mt-2">Login to view restricted briefings</p>
                </div>
                ...
                <div className="mt-6 text-center">
                    <p className="text-sm text-gray-400">
                        New agent?{' '}
                        <Link to="/register" className="font-medium text-geo-red hover:text-red-500">
                            Request clearance
                        </Link>
                    </p>
                </div>
